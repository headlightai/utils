...
VideoFromRosbag::VideoFromRosbag() {
  yaml_dir_ =
      ament_index_cpp::get_package_share_directory("utils") + "/config/video_from_rosbag.yaml";
...
int main(int, char**) {
  video_from_rosbag::VideoFromRosbag::Ptr rosbag_to_video =
      std::make_shared<video_from_rosbag::VideoFromRosbag>();
  return 0;
}
